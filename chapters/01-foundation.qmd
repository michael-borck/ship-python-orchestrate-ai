...
```bash
# Download the script
curl -O https://raw.githubusercontent.com/michael-borck/ship-it-template/main/scripts/scaffold_python_project.sh
...
1. Visit the template repository at https://github.com/michael-borck/ship-it-template
