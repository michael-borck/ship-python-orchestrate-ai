...
::: {.callout-tip title="AI Tip: Notebooks and AI Assistants"}
...
**Next**: In @sec-notebook-case-study, we'll build TextKit — a complete Python package developed entirely in notebooks using nbdev.
