...
::: {.callout-tip title="AI Tip: Dependency Decisions"}
...
::: {.callout-tip title="AI Tip: Generating Tests"}
...
::: {.callout-tip title="AI Tip: Adding Type Hints to Existing Code"}
