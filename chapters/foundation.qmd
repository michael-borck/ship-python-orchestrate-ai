...
::: {.callout-tip title="AI Tip: Scaffolding with AI"}
...
::: {.callout-note}
This chapter focuses on script-based projects, but notebooks (Jupyter, Colab) are also a legitimate way to ship Python work. For data scientists, educators, and researchers, a well-structured notebook with a sharing link *is* shipping. We cover notebooks, dashboards, and interactive tools in @sec-notebooks.
:::
...
::: {.callout-tip title="AI Tip: Git and AI Work Well Together"}
...
The cookiecutter template offers more customisation options and includes:
