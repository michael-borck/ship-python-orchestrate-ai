...
And it is not a book about vibe coding. Vibe coding — prompting AI until something runs, without understanding it — is fine for a throwaway script. It collapses the moment you try to *ship*. You cannot vibe a CI pipeline that catches real bugs, a package other people can install, a build that targets web, desktop, and containers from one codebase, or a test suite trustworthy enough to let an agent verify its own work. Deployment is where "it works on my machine" meets reality, and reality does not accept vibes. This book builds the structure that makes AI-generated code safe to ship — and with it, the one part of your work that does not commoditise: the judgement that decides what to ship and why. The deeper argument for staying in control of AI is in *Conversation, Not Delegation*.
...
- **Run the code.** All code examples and templates are available on [GitHub](https://github.com/michael-borck/ship-python-orchestrate-ai). [DeepWiki](https://deepwiki.com/michael-borck/ship-python-orchestrate-ai) provides an AI-navigable view of the repository.
