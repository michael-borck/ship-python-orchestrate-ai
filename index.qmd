...
- **Cookiecutter template**: `cookiecutter gh:michael-borck/ship-python-cookiecutter` for full customisation
...
We'll discuss how to use and customise these templates throughout the guide.
...
1. **Clear project structure**: AI can navigate and modify organised code
