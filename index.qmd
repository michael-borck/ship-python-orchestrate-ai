...
- **Cookiecutter template**: `cookiecutter gh:michael-borck/ship-it-cookiecutter` for full customization
- **GitHub template**: [ship-it-template](https://github.com/michael-borck/ship-it-template) for quick starts
- **Example project**: [ship-it-example](https://github.com/michael-borck/ship-it-example) showing all features in action
...
**Ship It: Python in Production** (this book) - Architecting for AI-assisted development with modern tools (uv, ruff, mypy, pytest) and multi-platform distribution
